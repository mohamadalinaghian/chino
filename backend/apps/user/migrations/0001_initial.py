# Generated by Django 5.2.4 on 2025-08-11 20:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(db_index=True, max_length=11, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_mobile', message='Mobile number must be in the format 09XXXXXXXXX', regex='^09\\d{9}$')], verbose_name='Mobile')),
